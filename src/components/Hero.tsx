    ...
    return (
        <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-[#FAFAF9]">
            ...
            <div className="container relative z-10 px-4 md:px-6 text-center flex flex-col items-center">
                ...
                >
                    Apurva <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-500">Mishra</span>
                </motion.h1>
                ...
                >
                    Senior AI Automation Developer & Full Stack Engineer.
                    Building rigorous, agentic workflows and premium web experiences.
                </motion.p>
