            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                        <Link
                            href="mailto:apurvamishra13@gmail.com"
                            className="px-8 py-4 rounded-full bg-stone-900 text-white font-bold text-lg hover:bg-orange-600 transition-colors shadow-lg hover:shadow-orange-500/20 flex items-center gap-3"
                        >
