...
export const ContextMenu = () => {
    ...
    const handleCopyEmail = () => {
        navigator.clipboard.writeText("apurvamishra13@gmail.com");
        setVisible(false);
        addToast({
            title: "Email Copied",
            ...
            {visible && (
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="grid grid-cols-3 gap-2 mb-2 px-1">
                        {[
                            { icon: <Mail className="w-5 h-5" />, label: "Email", action: () => window.location.href = "mailto:apurvamishra13@gmail.com" },
                            { icon: <Linkedin className="w-5 h-5" />, label: "LinkedIn", action: () => window.open("https://www.linkedin.com/in/apurva-kr-mishra", "_blank") },
                            { icon: <Github className="w-5 h-5" />, label: "GitHub", action: () => window.open("https://github.com/apurva130401", "_blank") }
                        ].map((item, i) => (
                            <button
                                key={i}
                                onClick={(e) => {
                    ...
                    <div className="flex flex-col gap-1 px-1">
                        ...
                        <motion.button
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                window.open("https://github.com/Apurva130401/apurva-mishra", "_blank");
                                setVisible(false);
                            }}
                            className="w-full flex items-center justify-between p-2.5 rounded-lg hover:bg-white/10 text-stone-300 hover:text-white group transition-all duration-200"
                        >
